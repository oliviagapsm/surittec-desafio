...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.surittec.desafio.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Desafio Surittec",
				"Avalição para seleção Desenvolvedor Júnior.", "Versão 1.0",
				"https://github.com/ycc-blue/surittec-desafio.git",
				new Contact("Yasmin do Carmo Costa", "https://github.com/ycc-blue/surittec-desafio.git", "yasmin_nim@hotmail.com"),
				null, 
